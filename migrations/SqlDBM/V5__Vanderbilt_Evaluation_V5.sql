-- ****************************** SqlDBM: Snowflake *****************************
-- * Generated by SqlDBM: Vanderbilt Evaluation by nathan.dryden@vanderbilt.edu *
...
(
 ...
 col_3                     varchar2 NOT NULL,
 LOYALTY_LEVEL_DESCRIPTION varchar2 NOT NULL,
 "EFFECTIVE START DATE"      datetime NOT NULL,
 "EFFECTIVE END DATE"        datetime NOT NULL,
 CURRENT_LEVEL             binary NOT NULL,
 C_CUSTKEY                 varchar2 NOT NULL,

 CONSTRAINT PK_1 PRIMARY KEY ( LOYALTY_ID )
);
